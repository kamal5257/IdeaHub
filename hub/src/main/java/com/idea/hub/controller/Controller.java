...
public class Controller {
	...
	public ResponseEntity<?> createAuthenticationTokken(@RequestBody AuthenticationRequest authenticationRequest) throws Exception{
		try {
		...
		if(jwt!=null) 
		{
			//User user = this.userRepository.getByEmail(authenticationRequest.getUsername());
	...
	public ResponseEntity<?> createUser(@RequestBody User user)
	{
		...
		try {
			...
			return new ResponseEntity<>("Bad Resquest", HttpStatus.BAD_REQUEST);
			}
	...
	public ResponseEntity<?> changePass(@RequestBody ChangePass changePass, Principal principal)
	{
		...
		if(oldPass.equals(currentUser.getPassword()))
		{
			...
			else { return new ResponseEntity<>("Password Doesn't Matched ! try again.", HttpStatus.BAD_REQUEST);}
		}
	...
	@PreAuthorize("hasAuthority('ROLE_ADMIN')")
	public ResponseEntity<?> editUser(@PathVariable("Id") long Id, @RequestBody EditUser editUser , Principal principal)
	{
		try {
